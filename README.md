...
A simple Harmony mod for Schedule I that makes plants and shrooms grow even after 4AM.
...
4. For each missing dependency, copy required libraries to the respective *_libs directories.
	...
	* Note: You must switch to the main branch and run the game once for IL2CPP libraries to be generated by MelonLoader, and you must switch to the alternate branch for Mono libraries to be populated.
5. Build. Project output will be in bin directory. Vortex packages will be in packages directory.
...
* Manual: Copy PlantsAlwaysGrowIL2CPP.dll/PlantsAlwaysGrowMono.dll from project bin/<IL2CPP|Mono>/net* directory to Schedule I's mods directory.
